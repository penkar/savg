...
class SkyScrapper extends React.Component {
  render() {
    return (
      <g>
        <rect className="light-blue" x="0" y="0" height="310" width="60"/>
        <line stroke-width="3" className="brown" x1="15" y1="69" x2="45" y2="69" />
        ...
        <line stroke-width="1" className="brown" x1="22" y1="84" x2="22" y2="300" />
        <line stroke-width="1" className="brown" x1="26" y1="84" x2="26" y2="300" />
        <line stroke-width="1" className="brown" x1="30" y1="84" x2="30" y2="300" />
        <line stroke-width="1" className="brown" x1="34" y1="84" x2="34" y2="300" />
        <line stroke-width="1" className="brown" x1="38" y1="84" x2="38" y2="300" />

        <polygon className="brown" points="20,50 40,50 30,10"/>
        <line stroke-width="3" className="orange" x1="18" y1="53" x2="42" y2="53" />
